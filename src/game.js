...
Portato.mainState = function(game) {
};
Portato.mainState.prototype = {
	preload:function(){
...
Portato.mainMenu.prototype = {
	...
	create:function(){
		...
		button = game.add.button(game.world.centerX-46, game.world.centerY+20, 'potato', function(){game.state.start('test');}, this);
	}
};

var game = new Phaser.Game(1024, 640, Phaser.AUTO, '', Portato.mainMenu);
game.state.add("test",Portato.mainState);